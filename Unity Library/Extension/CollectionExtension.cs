...
namespace Rito.UnityLibrary.Extension
{
    ...
    public static class CollectionExtension
    {
        ...
        ***********************************************************************/
        ...
        public static void Ex_LogAllElements<T>(this List<T> @this, string seperator = " ", bool showIndex = false)
        {
        ...
        /// </summary>
        [System.Diagnostics.Conditional(ConditionalDebugKeyword)]
        public static void Ex_LogAllElements<T>(this T[] @this, string seperator = " ", bool showIndex = false)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
        ...
        ***********************************************************************/
        ...
        public static T[] Ex_GetRandomElements<T>(this T[] @this, int count)
        {
            int len = @this.Length;
            if (len == 0) return null;
            if (count <= 0) return null;
        ...
        public static List<T> Ex_Shuffle<T>(this List<T> @this)
        {
        ...
        /// <summary> 리스트의 내용을 무작위로 섞기 (Fisher-Yates shuffle 알고리즘) </summary>
        public static T[] Ex_Shuffle<T>(this T[] @this)
        {
            int n = @this.Length;
            while (n > 1)
            {
